      ...
      <div className="bg-white py-5 px-4 sm:px-6 lg:px-8 ">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-5">
            <h2 className="text-[20px] font-bold text-[#019B83] leading-[100%] mb-4">
              Meet Our Team
              <span className="block w-40  mx-auto mt-1 z-40 relative">
          ...
          <div className="space-y-16 relative z-40">
            {/* Row 1 */}
            <div className=" flex flex-col justify-center items-center space-y-5 z-40 relative">
              <Image
                src={teamlead}
                alt="Teamlead"
                className="z-40"
                ...
                height={200}
              />
              <h3 className="text-center font-bold text-[#051609]  leading-[100%]  relative z-40">
                Leonard Jesse Hyuwa
              </h3>
            </div>
            ...
            <div className="absolute w-[15rem] top-[-5rem] right-0">
              <Image src={circle1} alt="circle1" className="z-0" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 z-40 relative">
              <div className="text-center  space-y-5 z-40 ">
                <Image
                  ...
                  height={200}
                />
                <h3 className="z-40 font-bold text-[#051609] leading-[100%] relative">
                  Christopher Francis
                </h3>
              </div>
              <div className="text-center  space-y-5 z-40">
                <Image
                  ...
                  height={200}
                />
                <h3 className="z-40 font-bold text-[#051609] leading-[100%]">Richard Dambo</h3>
              </div>
              <div className="text-center  space-y-5 z-40 ">
                <Image
                  src={team4}
                  ...
                  height={200}
                />
                <h3 className="z-40 font-bold text-[#051609]  leading-[100%]">Jessica Jude Aboi</h3>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 z-40 relative">
              <div className="text-center  space-y-5 z-40">
                ...
                <h3 className="z-40 font-bold text-[#051609]  leading-[100%]">Iweobi Prisca Ogonna </h3>
              </div>
              <div className="text-center  space-y-5 z-40 ">
                <Image src={team6} alt="team3" className="z-40" />
                <h3 className="z-40 font-bold text-[#051609]  leading-[100%]">Deborah Abashiya</h3>
              </div>
              <div className="text-center space-y-5 z-40 ">
                <Image src={team7} alt="team4" className="z-40" />
                <h3 className="z-40 font-bold text-[#051609] leading-[100%]">Samuel Dankard</h3>
              </div>
            </div>
