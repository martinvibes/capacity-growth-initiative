...
export default function WhatWeDoPage() {
  return (
    <PageTemplate title="What We Do" showHeader={false}>
      {/* Goals Section */}
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-8 relative z-40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#019B83] mb-4 relative z-40">
              What We Do
            ...
            <p className="text-lg text[#051609] relative z-40 font-semibold max-w-3xl mx-auto mt-6">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-40">
            <div className="text-[#051609] p-[20px] bg-[#F9F9F9]  flex flex-col relative rounded-[10px]">
              <div>
            ...
            <div className="text-[#051609] p-[20px] bg-[#F9F9F9] flex flex-col rounded-[10px] relative z-40">
              <div>
          ...
          <section className="flex   mt-10 gap-8 relative z-40">
            <div className="text-[#051609] p-[20px] bg-[#F9F9F9] flex flex-col rounded-[10px]">
              <div>
