          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16 text-center z-40">
            ...
            <div className="z-50 relative">
              ...
              <p className="text-[14px] leading-[180%] font-normal text-start">
                ...
                economy. Offer training in digital literacy, coding and emerging
                technologies .Create innovation hub for tech-driven problem
                solving .Connect participants with global tech communities
              </p>
            </div>
            <div className="absolute w-[15rem] top-20 left-[30rem] ">
              <Image src={circle1} alt="circle1" className="z-0" />
            </div>
